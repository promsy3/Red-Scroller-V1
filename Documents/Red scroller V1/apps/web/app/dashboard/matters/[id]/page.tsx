      ...
      <div className="rs-matter-info-grid">
        ...
        <div className="rs-info-card">
          ...
          <p className="rs-info-value">
            {matter.assignee?.email || (matter.assignee?.clerkId ? `User: ${matter.assignee.clerkId.substring(0, 8)}...` : '—')}
          </p>
        </div>
        <div className="rs-info-card">
              ...
              <div key={doc.id} className="rs-document-item">
                <div className="rs-document-info">
                  ...
                  <p className="rs-document-meta">
                    {doc.mimeType || 'Unknown type'} · {doc.sizeBytes ? `${(doc.sizeBytes / 1024).toFixed(1)} KB` : '—'} · Uploaded by {doc.uploader?.email}
                  </p>
                </div>
