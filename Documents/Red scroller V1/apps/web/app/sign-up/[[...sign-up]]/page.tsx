...
export default function SignUpPage() {
  return (
    <main className="rs-login-page">
      <section className="rs-login-panel" aria-label="RedScroller sign up">
        <div className="rs-login-brand">
          <BrandMark />
          <span>Red<span>Scroller</span></span>
        </div>

        <p className="rs-login-eyebrow">Get started</p>
        <h1>Create your account</h1>
        <p className="rs-login-subtitle">Join RedScroller to manage your legal matters efficiently.</p>
